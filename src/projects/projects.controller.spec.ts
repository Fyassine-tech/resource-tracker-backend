...
describe('ProjectsController', () => {
  ...
  const mockService = {
    ...
    findOne: jest.fn<Promise<Project | null>, [number]>(async (id) => ({ id, name: 'Demo', description: null } as Project)),
    create: jest.fn<Promise<Project>, [CreateProjectDto]>(async (dto) => ({ id: 1, name: dto.name, description: dto.description ?? null } as Project)),
    update: jest.fn<Promise<Project | null>, [number, UpdateProjectDto]>(async (id, dto) => ({ id, name: dto.name ?? 'Demo', description: dto.description ?? null } as Project)),
